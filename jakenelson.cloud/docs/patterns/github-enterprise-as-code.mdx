...
Users and group can be [synced from azure-ad](notes/tech/github/syncing-github-groups-from-azuread.mdx) or configured statically.
...
A repository module should be used to ensure that [repository best practices](notes/tech/github/github-repo-best-practices.mdx) are being adhered to.
